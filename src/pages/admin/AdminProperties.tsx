...
interface AssetForm {
  ...
  asking_land_price: string;
  asking_building_price: string;
...
const emptyForm: AssetForm = {
  ...
  current_floor_area: '', land_value_per_sqm: '', asking_land_price: '', asking_building_price: '',
    ...
    <div className="mx-auto max-w-6xl px-4 pb-8 pt-32">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={handleBulkRescore} disabled={rescoring}>
